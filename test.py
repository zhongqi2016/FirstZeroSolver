...
def print_com_res(head_line, iterations):
    if isinstance(head_line, str):
        print(head_line)
...
def test_linear(df, eps, repeat):
    ...
    print_com_res(headline, full_interval_list)
...
def test_division(df, eps, repeat, alp=0.7, reduction=True, rho_g=36, rho_l=36):
    ...
    # else:
    headline = '№, Bisection, Piyavskii, Casado, Falsi, FalsiTan'
    print_com_time(headline, time_list)
